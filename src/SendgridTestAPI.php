...
/**
 * @file
 * Contains \Drupal\sendgrid\SendgridTestAPI.
 */

namespace Drupal\sendgrid;

/**
 * Overrides functions in the Sendgrid API service for testing.
 */
class SendgridTestAPI extends SendgridAPI {
  ...
  public function sendTemplate($message, $template_id, $template_content) {
    ...
    $recipients = sendgrid_get_to($message['to']);
  ...
  /**
   * Gets a Sendgrid-style formatted error response.
   *
   * @param int $code
   *   The Sendgrid error code.
   * @param string $name
   *   The name of the Sendgrid error type (ValidationError, etc.)
   * @param $message
   *   The error message.
   *
   * @return array
  ...
  protected function getSendersTestData() {
    ...
    // Sender One
    $sender = array(
      'address' => 'sender.one@sendgridapp.com',
      'created_at' => '2013-01-01 15:30:27',
      'sent' => 42,
      'hard_bounces' => 42,
      'soft_bounces' => 42,
    ...
    // Sender Two
    $sender = array(
      'address' => 'sender.two@sendgridapp.com',
      'created_at' => '2013-01-01 15:30:27',
      'sent' => 42,
      'hard_bounces' => 42,
      'soft_bounces' => 42,
